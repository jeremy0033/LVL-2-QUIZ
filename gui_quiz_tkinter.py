quiz_data = [
    ...
    # Section 3: Fashion & Music History (10 questions)
...
# 3. Quiz Data
quiz_data = [
    # Your 30 questions here as dictionaries
]
...
def show_question():
    ...
    if current_question < len(quiz_data):
        q_data = quiz_data[current_question]
...
def end_quiz():
    ...
    messagebox.showinfo("Quiz Complete", f"Your total score is {score} / {len(quiz_data)}\n\nSection Scores:\n{section_summary}")
    root.destroy()
...
# Disable question buttons initially
for btn in option_buttons:
    btn.config(state=tk.DISABLED)
...
instructions_label = tk.Label(root, text="Click Start to begin. Answer the questions by clicking the correct option.", font=("Arial", 14))
instructions_label.pack(pady=10)

# --- Section Selection ---
section_choice_label = tk.Label(root, text="Choose a section to start with:", font=("Arial", 14))
section_choice_label.pack(pady=10)
